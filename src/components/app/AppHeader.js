...
export class AppHeader extends LitElement {
    ...
    getViewTitle() {
        const titles = {
            onboarding: 'Welcome to ContextHalo',
            main: 'ContextHalo',
            customize: 'Customize',
            help: 'Help & Shortcuts',
            history: 'Conversation History',
            advanced: 'Advanced Tools',
            assistant: 'ContextHalo',
        };
        return titles[this.currentView] || 'ContextHalo';
    }
                    ...
                    ${this.currentView === 'assistant'
                        ? html`
                              <button @click=${this.onHideToggleClick} class="button">
                                  Hide&nbsp;&nbsp;<span class="key" style="pointer-events: none;">${contextHalo.isMacOS ? 'Cmd' : 'Ctrl'}</span
