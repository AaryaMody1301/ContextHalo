...
let logStream = null;
let bytes = 0;
const ALLOWED = new Set(['sessionId', 'model', 'status', 'code', 'chunkLength', 'provider', 'durationMs', 'operation', 'category', 'retryAfterMs', 'attempt', 'networkCode', 'stage', 'quotaScope', 'searchAttached', 'searchControl']);
