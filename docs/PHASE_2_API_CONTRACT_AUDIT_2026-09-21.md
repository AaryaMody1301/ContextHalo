...
| Retry owner | SDK retries forced to one attempt; ContextHalo owns up to four HTTP attempts inside the single provider budget | recovery/service recovery/SDK wire tests | https://ai.google.dev/gemini-api/docs/api-errors |
