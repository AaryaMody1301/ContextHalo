...
edit('src/utils/windowModeController.js', 'HUD_MINIMUM_SIZE.height, Math.min(HUD_MAXIMUM_SIZE.height, workArea.height)', 'Math.min(520, workArea.height), Math.min(HUD_MAXIMUM_SIZE.height, workArea.height)')
...
edit('tests/windows-live-hud.test.js', '{ x: 387, y: 74, width: 792, height: 364 }', '{ x: 387, y: 74, width: 792, height: 520 }')
